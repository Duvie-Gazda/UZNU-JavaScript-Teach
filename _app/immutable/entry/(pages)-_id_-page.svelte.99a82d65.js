import{S as T,i as L,s as $,k as w,q as C,a as A,l as S,m as b,r as D,h as f,c as I,n as J,b as j,G as u,u as B,H as P,e as O,J as te,K as y,L as ne,g as E,v as re,d as N,f as ie,y as ce,z as oe,A as se,B as le,M as pe,I as he}from"../chunks/index.d09ad2c3.js";import{p as ue}from"../chunks/stores.06870b02.js";let ae=class{constructor(t,r,e){this.id=t,this.questions=e,this.result=r}checkExam(){const t=this.questions.reduce((r,e)=>r+e.mark,0);return this.result=Number.parseInt((100*t/this.questions.length).toFixed(0)),this.result}clear(){this.result=0;for(const t of this.questions)t.answered=!1,t.chosenAnswer=void 0,t.mark=0}convertToMiniExam(){var r;const t={questions:[],id:this.id,result:this.result};for(const e of this.questions)t.questions.push({id:e.id,answeredId:(r=e.chosenAnswer)==null?void 0:r.id});return t}updateWithMiniExam(t){this.result=t.result;for(const r of this.questions){const e=t.questions.find(n=>n.id==r.id);e!=null&&e.answeredId&&r.makeAnswer(e==null?void 0:e.answeredId)}}};class fe extends ae{save(){const t=JSON.stringify(this.convertToMiniExam());localStorage.setItem("exam-"+this.id,t)}upload(){const t=localStorage.getItem("exam-"+this.id)||"";if(t=="")return;const r=JSON.parse(t);this.updateWithMiniExam(r)}}const ve=[{id:1,article:{id:1,title:"Вступ до JavaScript",text:`<h1>Вступ до JavaScript</h1>
